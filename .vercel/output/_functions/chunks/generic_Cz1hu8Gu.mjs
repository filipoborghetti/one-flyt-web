import { f as fetchWithRedirects, g as getConfiguredImageService, i as imageConfig } from './_astro_assets_CUyWygAZ.mjs';
import { m as isRemoteAllowed, n as isRemotePath } from './entrypoint_CeS0V7Kk.mjs';
